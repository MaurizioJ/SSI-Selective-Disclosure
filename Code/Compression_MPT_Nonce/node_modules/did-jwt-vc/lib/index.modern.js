...
const _excluded = ["iat", "nbf", "claim", "vc"];
/*
...
function normalizeCredential(input, removeOriginalFields = true) {
  ...
  if (typeof input === 'string') {
    ...
    return deepCopy(_extends({}, normalizeJwtCredential(input.proof.jwt, removeOriginalFields), {
      proof: input.proof
    }));
  } else {
...
function normalizePresentation(input, removeOriginalFields = true) {
  ...
  if (typeof input === 'string') {
    ...
    // TODO: test that it correctly propagates app specific proof properties
    return _extends({}, normalizeJwtPresentation(input.proof.jwt, removeOriginalFields), {
      proof: input.proof
    });
  } else {
