...
const test = async (accounts) => {
    ...
    for (let i = 1; i <11; i++) {
        ...
        vcCreationTimes.push([res/config.merkleTree.iterations, jwtSize/config.merkleTree.iterations, getStandardDeviation(timeElapsed)]);
        console.log("-------------------------------------------------------------------------")
    ...
    const file = fs.createWriteStream('2-Compression-MT-VP-issue-Lsha256-Tkeccak-.txt');
