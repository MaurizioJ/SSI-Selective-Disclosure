 ...
 */
export declare type StatusMethod = (credential: string, didDoc: DIDDocument) => Promise<null | CredentialStatus>;
 ...
 */
export declare class Status implements StatusResolver {
    private registry;
    /**
